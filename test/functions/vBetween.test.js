...
describe('vBetween', () => {
    ...
    it('should not allow other types as values', () => {
        ...
        invalid_keys.forEach(key => expect(evaluation.errors[key]).to.deep.equal([{msg:'between', params: ['2', '300']}]));
    });

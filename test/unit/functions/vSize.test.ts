...
describe('vSize', () => {
    ...
    it('Should allow a string as an acceptable value', () => {
        expect(new Validator({a: 'size:16'}).check({a: 'this is a string'})).toBe(true);
    });

    it('Should allow an array as an acceptable value', () => {
        expect(new Validator({a: 'size:5'}).check({a: ['foo', 'bar', 'hello', 'world', 'sweet']})).toBe(true);
    });
    ...
    describe('String', () => {
        ...
        it('Should validate a string whose length is equal to the provided parameter as valid', () => {
            expect(new Validator({a: 'size:11'}).check({a: 'hello world'})).toBe(true);
        });
    ...
    describe('Array', () => {
        ...
        it('Should validate an array whose length is equal to the provided parameter as valid', () => {
            expect(new Validator({a: 'size:5'}).check({a: ['apple', 'pear', 'orange', 'melon', 'grape']})).toBe(true);
        });
